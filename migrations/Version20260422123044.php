...
final class Version20260422123044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cabinet (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(150) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE prescription (id INT AUTO_INCREMENT NOT NULL, posologie VARCHAR(255) NOT NULL, frequence VARCHAR(100) NOT NULL, duree_jours INT NOT NULL, quantite INT NOT NULL, ordonnance_id INT NOT NULL, medicament_id INT NOT NULL, INDEX IDX_1FBFB8D92BF23B8F (ordonnance_id), INDEX IDX_1FBFB8D9AB0D61F7 (medicament_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, date_heure DATETIME NOT NULL, duree INT NOT NULL, statut VARCHAR(50) NOT NULL, motif VARCHAR(255) DEFAULT NULL, patient_id INT DEFAULT NULL, medecin_id INT DEFAULT NULL, INDEX IDX_65E8AA0A6B899279 (patient_id), INDEX IDX_65E8AA0A4F31A84 (medecin_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
